...
string m_w_base_api::ConvertToStringSid(const unsigned char* bsid, const int len){
...
// sid -> username
string m_w_base_api::sid2user(PSID pSid, LPCTSTR lpSystemName){
