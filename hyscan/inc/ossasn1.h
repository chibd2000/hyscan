...
/*****************************************************************************/
/*****************************************************************************/
/* $Id: be7357c25edab0b8ad0285c96dac1e0034ba2e08 $ */
/*****************************************************************************/
...
#ifndef LONG_LONG
#if defined(_MSC_VER) || defined(__BORLANDC__) || defined(MINGW_WIN32) || defined(MINGW_WIN64)
...
#ifndef OSS_PTR_MAX
#define OSS_PTR_MAX ((char*)ULLONG_MAX)
#endif
...
#if !defined(OSS_IN_COMPILER) && defined(OSS_RTOED) \
        && (defined(OSS_CUSTOM_C) || defined(OSS_CUSTOM_I) \
            || defined(OSS_ANNEX_K) || defined(OSS_CUSTOM_V))
#if defined(OSS_CUSTOM_C)
#include "safe_lib.h"
#include "safe_mem_lib.h"
#include "safe_str_lib.h"
#define OSS_STR_TIME_MAX_LENGTH                 256  /* TIME size */
#define OSS_MAXIMUM_ITEM_SIZE                   1024 /* Token item size */
#define OSS_MAX_LINE_LENGTH                     4096 /* REAL/INTEGER size */
#define OSS_MAX_STR                             RSIZE_MAX_STR
#define OSS_SET_CONSTRAINT_HANDLER(hdl)         set_str_constraint_handler_s(hdl); \
                                                set_mem_constraint_handler_s(hdl);
#define OSS_MEMCMP_RES(name)                    int name;
#define OSS_STRCMP_RES(name)                    int name;
#define OSS_STRCHR_RES(name)                    char *name;
#define OSS_MEMCHR_RES(name)                    char *name;

#define OSS_MEMCPY(w, dest, dmax, src, slen)    (void)memcpy_s(dest, (rsize_t)(dmax), src, (rsize_t)(slen))
#define OSS_MEMMOVE(w, dest, dmax, src, slen)   (void)memmove_s(dest, (rsize_t)(dmax), src, (rsize_t)(slen))
#define OSS_MEMCMP(w, dest, dmax, src, slen, diff) (memcmp_s(dest, (rsize_t)(dmax), src, (rsize_t)(slen), &diff), diff)
#define OSS_MEMSET(w, dest, dmax, value, n)     (void)memset_s(dest, (rsize_t)(dmax), value, (rsize_t)(n))
#define OSS_MEMCHR(w, dest, dmax, ch, resultp)  (memchr_s(dest, (rsize_t)(dmax), ch, (void **)&(resultp)), resultp)
#define OSS_STRCAT(w, dest, dmax, src)          strcat_s(dest, (rsize_t)(dmax), src)
#define OSS_STRCPY(w, dest, dmax, src)          strcpy_s(dest, (rsize_t)(dmax), src)
#define OSS_STRNCPY(w, dest, dmax, src, slen)   strncpy_s(dest, (rsize_t)(dmax), src, (rsize_t)(slen))
#define OSS_STRCMP(w, dest, dmax, src, ind)     (strcmp_s(dest, (rsize_t)(dmax), src, &ind), ind)
#define OSS_STRCHR(w, dest, dmax, ch, resultp)  (strchr_s(dest, (rsize_t)(dmax), ch, &(resultp)), resultp)
#define OSS_STRNLEN(dest, dmax)                 strnlen_s(dest, (rsize_t)(dmax))
#define OSS_SPRINTF(w, s, n, ...)               sprintf_s(s, (rsize_t)(n), __VA_ARGS__)
#define OSS_VFPRINTF(w, f, ...)                 vfprintf_s(f, __VA_ARGS__)
#define OSS_VSPRINTF(w, s, dmax, ...)           vsprintf_s(s, (rsize_t)(dmax), __VA_ARGS__)
#define OSS_VSNPRINTF(w, s, dmax, count, ...)   vsnprintf_s(s, (rsize_t)(dmax), __VA_ARGS__)

#elif defined(OSS_CUSTOM_I)
#include "safe_lib.h"
int sprintf_s(char *restrict s, size_t n, const char *restrict format, ...);

#define OSS_STR_TIME_MAX_LENGTH                 256  /* TIME size */
#define OSS_MAXIMUM_ITEM_SIZE                   1024 /* Token item size */
#define OSS_MAX_LINE_LENGTH                     4096 /* REAL/INTEGER size */
#define OSS_MAX_STR                             0x7fffffff
...
#define OSS_MEMCPY(w, dest, dmax, src, slen)    (void)memcpy_s(dest, (size_t)(dmax), src, (size_t)(slen))
#define OSS_MEMMOVE(w, dest, dmax, src, slen)   (void)memmove_s(dest, (size_t)(dmax), src, (size_t)(slen))
#define OSS_MEMCMP(w, dest, dmax, src, slen, diff) memcmp_s(dest, (size_t)(dmax), src, (size_t)(slen))
#define OSS_MEMSET(w, dest, dmax, value, n)     (void)memset_s(dest, (size_t)(dmax), value, (size_t)(n))
#define OSS_MEMCHR(w, dest, dmax, ch, resultp)  memchr(dest, ch, (size_t)(dmax))
#define OSS_STRCAT(w, dest, dmax, src)          strcat_s(dest, (size_t)(dmax), src)
#define OSS_STRCPY(w, dest, dmax, src)          strcpy_s(dest, (size_t)(dmax), src)
#define OSS_STRNCPY(w, dest, dmax, src, slen)   strncpy_s(dest, (size_t)(dmax), src, (size_t)(slen))
#define OSS_STRCMP(w, dest, dmax, src, ind)     strcmp(dest, src)
#define OSS_STRCHR(w, dest, dmax, ch, resultp)  strchr_s(dest, (size_t)(dmax), ch)
#define OSS_STRNLEN(dest, dmax)                 strnlen_s(dest, (size_t)(dmax))
#define OSS_SPRINTF(w, s, n, ...)               sprintf_s(s, (rsize_t)(n), __VA_ARGS__)
#define OSS_VFPRINTF(w, f, ...)                 vfprintf_s(f, __VA_ARGS__)
#define OSS_VSPRINTF(w, s, dmax, ...)           vsprintf_s(s, (rsize_t)(dmax), __VA_ARGS__)
#define OSS_VSNPRINTF(w, s, dmax, count, ...)   vsnprintf_s(s, (rsize_t)(dmax), __VA_ARGS__)

#elif defined(OSS_ANNEX_K)
#include "safe_lib.h"
#define OSS_STR_TIME_MAX_LENGTH                 256  /* TIME size */
#define OSS_MAXIMUM_ITEM_SIZE                   1024 /* Token item size */
#define OSS_MAX_LINE_LENGTH                     4096 /* REAL/INTEGER size */
#define OSS_MAX_STR                             RSIZE_MAX
#define OSS_SET_CONSTRAINT_HANDLER(hdl)         set_constraint_handler_s(hdl);
#define OSS_MEMCMP_RES(name)
#define OSS_STRCMP_RES(name)
#define OSS_STRCHR_RES(name)
#define OSS_MEMCHR_RES(name)
...
#elif defined(OSS_CUSTOM_V)
#define OSS_STR_TIME_MAX_LENGTH                 256  /* TIME size */
#define OSS_MAXIMUM_ITEM_SIZE                   1024 /* Token item size */
#define OSS_MAX_LINE_LENGTH                     4096 /* REAL/INTEGER size */
#define OSS_MAX_STR                             ULONG_MAX /* RSIZE_MAX */
#define OSS_SET_CONSTRAINT_HANDLER(hdl)
#define OSS_MEMCMP_RES(name)
#define OSS_STRCMP_RES(name)
#define OSS_STRCHR_RES(name)
...
#define OSS_MEMCPY(w, dest, dmax, src, slen)    memcpy_s(dest, (size_t)(dmax), src, (size_t)(slen))
#define OSS_MEMMOVE(w, dest, dmax, src, slen)   memmove_s(dest, (size_t)(dmax), src, (size_t)(slen))
#define OSS_MEMCMP(w, dest, dmax, src, slen, diff) memcmp(dest, src, (size_t)(slen))
...
#define OSS_STRCHR(w, dest, dmax, ch, resultp)  strchr(dest, ch)
#define OSS_STRNLEN(dest, dmax)                 strnlen_s(dest, (size_t)(dmax))
#define OSS_SPRINTF(w, s, n, ...)               sprintf_s(s, (size_t)(n), __VA_ARGS__)
#define OSS_VFPRINTF(w, f, ...)                 vfprintf_s(f, __VA_ARGS__)
#define OSS_VSPRINTF(w, s, dmax, count, ...)    vsprintf_s(s, (size_t)(dmax), __VA_ARGS__)
#define OSS_VSNPRINTF(w, s, dmax, count, ...)   _vsnprintf_s(s, (size_t)(dmax), (size_t)(count), __VA_ARGS__)

#endif /* OSS_CUSTOM_C */

#else   /* STANDARD STRING/MEMORY FUNCTIONS */
...
#endif  /* OSS_IN_COMPILER && OSS_RTOED && (OSS_CUSTOM_C || OSS_CUSTOM_I || OSS_ANNEX_K || OSS_CUSTOM_V) */
